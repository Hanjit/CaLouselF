...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2024 at 07:05 PM
...
INSERT INTO `msitem` (`Item_id`, `Item_name`, `Item_size`, `Item_price`, `Item_category`, `Item_status`, `Item_wishlist`, `Item_offer_status`, `Item_reason`, `Seller_id`) VALUES
(1, 'Baju Gembel Banget', 'Medium', '20000', 'Baju', 'Approved', '-', 'NULL', NULL, 3),
(2, 'Celana Gembel Banget', 'Medium', '50000', 'Celana', 'Approved', '-', 'NULL', NULL, 3),
(3, 'Topi Gembel', 'Large', '10000', 'Aksesoris', 'Approved', '-', 'NULL', NULL, 2),
(5, 'Baju Keren', 'Small', '100000', 'Baju', 'Approved', '-', '-', NULL, 3);
...
(2, 'buyer', 'buyer', 'cobain', 'cobain', 'Buyer'),
(3, 'seller', 'seller', 'hanjit', 'hanjit', 'Seller');
...
ALTER TABLE `mswishlist`
  ...
  ADD KEY `User_id` (`User_id`),
  ADD KEY `FK_wishlistitem` (`Item_id`);
...
--
-- Constraints for table `msitem`
--
ALTER TABLE `msitem`
  ADD CONSTRAINT `fk_seller_user` FOREIGN KEY (`Seller_id`) REFERENCES `msuser` (`User_id`);
...
ALTER TABLE `msoffer`
  ...
  ADD CONSTRAINT `FK_offeritem` FOREIGN KEY (`Item_id`) REFERENCES `msitem` (`Item_id`) ON DELETE CASCADE,
...
--
ALTER TABLE `mswishlist`
  ADD CONSTRAINT `FK_wishlistitem` FOREIGN KEY (`Item_id`) REFERENCES `msitem` (`Item_id`) ON DELETE CASCADE,
